// 配置存储键名
const STORAGE_KEY_API_URL = "gcli2_monitor_api_url";
const STORAGE_KEY_SECRET = "gcli2_monitor_secret_key";
...
// 从 localStorage 读取配置，默认指向当前 gcli2 面板地址与登录 token
const DEFAULT_API_URL = localStorage.getItem(STORAGE_KEY_API_URL) || window.location.origin || "";
const DEFAULT_SECRET_KEY =
  localStorage.getItem(STORAGE_KEY_SECRET) ||
  localStorage.getItem("gcli2api_auth_token") ||
  "";

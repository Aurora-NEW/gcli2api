...
async def messages(
    ...
    if not is_streaming:
        ...
        response = await non_stream_request(body=api_request, api_tag="antigravity/anthropic")
    ...
    async def anti_truncation_generator():
        ...
        async def stream_request_wrapper(payload):
            ...
            stream_gen = stream_request(body=payload, native=False, api_tag="antigravity/anthropic")
    ...
    async def normal_stream_generator():
        ...
        stream_gen = stream_request(body=api_request, native=False, api_tag="antigravity/anthropic")
